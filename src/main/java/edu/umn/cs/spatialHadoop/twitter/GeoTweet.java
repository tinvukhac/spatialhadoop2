...
//		this.json = "{ \"type\": \"FeatureCollection\", \"features\": [ { \"type\": \"Feature\", \"properties\": { \"name\": \"Van Dorn Street\", \"marker-color\": \"#0000ff\", \"marker-symbol\": \"rail-metro\", \"line\": \"blue\" }, \"geometry\": { \"type\": \"Point\", \"coordinates\": [ -77.12911152370515, 38.79930767201779 ] } }, { \"type\": \"Feature\", \"properties\": { \"name\": \"Franconia-Springfield\", \"marker-color\": \"#0000ff\", \"marker-symbol\": \"rail-metro\", \"line\": \"blue\" }, \"geometry\": { \"type\": \"Point\", \"coordinates\": [ -77.16797018042666, 38.766521892689916 ] } }] }";
//		this.json = "{\"geometry\": { \"type\": \"Point\", \"coordinates\": [ -77.12911152370515, 38.79930767201779 ] }}";
//		this.json = "{ \"type\": \"Point\", \"coordinates\": [ -77.12911152370515, 38.79930767201779 ] }";
...
//				this.geom = reader.read("{\"coordinates\":[[[-80.282775,26.089889],[-80.282775,26.105196],[-80.265788,26.105196],[-80.265788,26.089889],[-80.282775,26.089889]]],\"type\":\"Polygon\"}");
			} 
